...
battleMatchSchema.index({ roomId: 1, status: 1, isGuestMatch: 1 });
battleMatchSchema.index({ roomId: 1, status: 1 });
battleMatchSchema.index({ status: 1, 'players.userId': 1 });
battleMatchSchema.index({ status: 1, 'player1.userId': 1 });
battleMatchSchema.index({ status: 1, 'player2.userId': 1 });
