...
battleLeaderboardSchema.index({ cycleId: 1, winsCount: -1, totalSpeedPoints: -1, lastMatchAt: 1 });
battleLeaderboardSchema.index({ cycleId: 1, totalSpeedPoints: -1, winsCount: -1, lastMatchAt: 1 });
