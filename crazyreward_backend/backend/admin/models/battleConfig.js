...
const battleConfigSchema = new mongoose.Schema({
    ...
    cycleType: { type: String, default: 'Weekly' }, // 'Daily', 'Weekly', 'Monthly'
    terms: {
        type: [battleTermSchema],
        default: [
            { title: "1. Acceptance of Terms", description: "By accessing or using this Quiz Application (\"App\"), you agree to be bound by these Terms and Conditions." },
            { title: "2. Fair Play & Anti-Cheat", description: "Minimizing the app or switching to Google during a battle will forfeit the current question." },
            { title: "3. Winner Coin Distribution", description: "Platform fee cut % is deducted automatically, and net coins are credited to the winner." }
        ]
    },
    isActive: { type: Boolean, default: true },
    botWinRate: { type: Number, default: 50 },
    ...
    allowBonusCoins: { type: Boolean, default: false }, // Toggle: allow bonus coins in Paid battles
    bonusUsagePercent: { type: Number, default: 0 }, // Max % of entry fee payable with bonus coins (0-100)
