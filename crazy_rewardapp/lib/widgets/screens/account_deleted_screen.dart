              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'This account and all associated user data have been permanently deleted from Crazyreward. If you wish to use the app again, please sign up with a new account.',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.outfit(
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        await LaunchUrl.openSupportContact(
                          context: context,
                          subject: 'Account Deleted Inquiry - Crazyreward',
                        );
                      },
                      child: Container(
                        height: 50.h,
